...
function App()
{
  ...
  {
    setstatus(true)
    axios.post("https://bulk-mail-alk0.onrender.com/sendemail",{msg:msg,emailList:emailList})
    .then(function(data)
  {
    if(data.data == true)
    {
  ...
  return(
    <div>
      ...
      <div className="bg-blue-400 flex flex-col items-center text-black px-5 py-3">
        ...
        <button onClick={send} className="bg-blue-950 py-2 px-2 text-white mt-2 font-medium rounded-md w-fit">{status?"Sending":"Send"}</button>
      </div>
